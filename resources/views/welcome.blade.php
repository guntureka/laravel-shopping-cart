...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] min-h-screen flex flex-col items-center justify-center p-6 lg:p-8">
    <div>
        <a href="{{ route('carts.index') }}" class="text-white hover:underline text-lg font-medium">
            Carts
        </a>
    </div>
</body>
